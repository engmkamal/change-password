...
// @Component({
//   selector: 'portal-systeminfohome',
//   templateUrl: './systeminfohome.component.html',
//   styleUrls: ['./systeminfohome.component.scss'],
// })
// export class SysteminfohomeComponent implements OnInit {
//   constructor() {}
...
export class SysteminfohomeComponent implements OnInit, AfterViewInit {
  ...
  async ngOnInit() {
    ...
    let pendingList = {
      apiUrl: `https://bergerpaintsbd.sharepoint.com/sites/BergerTech/_api/web/lists/getByTitle('customerregistration')/items?&$top=100&$select=*&$orderby=Created desc`,      
    };
      ...
      (items:any) => {
        ...
        for(let i=0; i<10; i++){
          let pt = {
            ...
            CustId: items.value[i].CustId,
            CustName: items.value[i].CustName,
            CustCompanyName: items.value[i].CustCompanyName,
            Cust1stEmail: items.value[i].Cust1stEmail,
            Status: items.value[i].Status,
            ProcessLink: items.value[i].ProcessLink,
    ...
    const dbListsInfoUrl = "https://bergerpaintsbd.sharepoint.com/sites/BergerTech/Style Library/bergertechportal/assets/custSystemInfoListsInfo.ts";
