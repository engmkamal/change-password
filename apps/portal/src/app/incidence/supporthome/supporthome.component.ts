  ...
  async GetOutputVal(valFrmChild: any) {
    ...
    switch (btnClkAction) {
      ...
      case "Assigned": {
        ...
        this.emitedDataFrmChild.AppParameters.AssignedTasks.forEach((ati:any, i:index) => {
          _newAssignTskItms.push({
            ...
            ReporterId: "1270", //should be replaced with logged user
            ReporterName: "Kamal", //should be replaced with logged user
            ReporterEmail: "kamal@bergerbd.com", //should be replaced with logged user
          });
      ...
      case "Completed": {
        ...
        // this.reviewLink = 'https://www.bergertechbd.com/?page_id=1957?guid=' + this.emitedDataFrmChild.uId + "&mode=read";
        // this.approvalLink = 'https://www.bergertechbd.com/?page_id=1957?guid=' + this.emitedDataFrmChild.uId ;
