...
// @Component({
//   selector: 'portal-myworkflowlanding',
//   templateUrl: './myworkflowlanding.component.html',
//   styleUrls: ['./myworkflowlanding.component.scss'],
// })
// export class MyworkflowlandingComponent implements OnInit {
//   constructor() {}
...
export class MyworkflowlandingComponent implements OnInit, AfterViewInit {
  ...
  async ngOnInit() {
    ...
    //const dbListsInfoUrl = "https://bergerpaintsbd.sharepoint.com/sites/BergerTech/Style Library/pendingtasks/V3/assets/dashboardslistsinfo.ts";
