...
export class ActionButtonsBarComponent {
  ...
  ngAfterViewInit(){
    if (this.requestInfo.uId != "") {       
      ...
      if(this.requestInfo.Status == "Submitted" || this.requestInfo.Status == "Assigned" || this.requestInfo.Status == "TaskPickedUp" || this.requestInfo.Status == "UATFeedbackFrmCustomer"){
